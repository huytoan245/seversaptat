...
new = "'EnsureListSelectionVisible','PreviewCacheKey','SchedulePreviewPrefetch','PreviewCacheCapacity','TryGetCachedPreview','SemaphoreSlim _previewRenderGate','ConfigureRightPaneRatio(inner, 0.13, 160, 230)'"
if old not in s:
