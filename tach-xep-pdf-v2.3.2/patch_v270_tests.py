...
smoke=r'''                // v2.7.0 feature regression: both merge modes, both extraction modes, list lifecycle.
                ...
                Task mergeUnsplitTask=MergePdfFilesCoreAsync(new string[]{mergePart},-1); while(!mergeUnsplitTask.IsCompleted){Application.DoEvents();Thread.Sleep(10);} mergeUnsplitTask.GetAwaiter().GetResult();
                ...
                SplitAndArrange(); Application.DoEvents();
